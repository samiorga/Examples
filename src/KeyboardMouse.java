...
public class KeyboardMouse extends JComponent implements KeyListener, MouseMotionListener, MouseListener{
    ...
    // another player
    Rectangle player = new Rectangle(100,200,48,110);
    int moveX = 0;
    int moveY = 0;
    boolean inAir = false;
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.drawImage(Player, player.x, player.y, player.width, player.height, null);
    ...
    public void run()
    {
        ...
        //add blocks
        blocks.add(new Rectangle(400,400,100,50));
        blocks.add(new Rectangle(500,350,50,50));
    ...
    public static void main(String[] args) {
        ...
        KeyboardMouse game = new KeyboardMouse();
